...
public class HviewPagerActivity extends AppCompatActivity  {
 ...
 每隔固定时间切换广告栏图片
    ...
    private void initPageAdapter() {
        ...
        img1.setBackgroundResource(R.drawable.view0);
        pageViews.add(img1);
        ImageView img2 = new ImageView(this);
        img2.setBackgroundResource(R.drawable.view1);
        pageViews.add(img2);
        ImageView img3 = new ImageView(this);
        img3.setBackgroundResource(R.drawable.view2);
        pageViews.add(img3);
        ImageView img4 = new ImageView(this);
        img4.setBackgroundResource(R.drawable.view3);
        pageViews.add(img4);
        ImageView img5 = new ImageView(this);
        img5.setBackgroundResource(R.drawable.view4);
        pageViews.add(img5);
